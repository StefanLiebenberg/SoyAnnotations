...
public class DynamicSoyListData extends SoyListData {

    private final DynamicResult<SoyListData> container;

    public DynamicSoyListData(DynamicResult<SoyListData> container) {
