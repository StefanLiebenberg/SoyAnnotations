...
public class DynamicSoyMapData extends SoyMapData {

    private final DynamicResult<SoyMapData> container;

    public DynamicSoyMapData(DynamicResult<SoyMapData> container) {
